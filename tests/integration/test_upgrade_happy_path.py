...
def test_change_in_manifest_reflected_again(
    ...
    assert_resource_does_not_exist(
        lightkube_client, ServiceAccount, SERVICE_ACCOUNT_NAME_2, namespace
    )
    assert_resource_exists(lightkube_client, ServiceAccount, SERVICE_ACCOUNT_NAME_3, namespace)
